...
car.h= 0.3; 
car.copx=0.45; %centre de pressions
...
yawslip = deg2rad(-10:10); % Intervalo Slip de CG en [rad]
...
w = v/R % Velocidad angular inicial [rad/s]
