    ...
    %% Perpendicularidad entre eje rocker y push
        FL_KINEMATICS.PUSH_RKR_DOT = dot((FL.PUSH_RKR - FL.PUSH_UW)/norm(FL.PUSH_RKR - FL.PUSH_UW), (FL.RKR_AXIS_1 - FL.RKR_AXIS_2)/norm(FL.RKR_AXIS_1 - FL.RKR_AXIS_2));
        FR_KINEMATICS.PUSH_RKR_DOT = dot((FR.PUSH_RKR - FR.PUSH_UW)/norm(FR.PUSH_RKR - FR.PUSH_UW), (FR.RKR_AXIS_1 - FR.RKR_AXIS_2)/norm(FR.RKR_AXIS_1 - FR.RKR_AXIS_2));
        RL_KINEMATICS.PUSH_RKR_DOT = dot((RL.PUSH_RKR - RL.PUSH_UW)/norm(RL.PUSH_RKR - RL.PUSH_UW), (RL.RKR_AXIS_1 - RL.RKR_AXIS_2)/norm(RL.RKR_AXIS_1 - RL.RKR_AXIS_2));
        RR_KINEMATICS.PUSH_RKR_DOT = dot((RR.PUSH_RKR - RR.PUSH_UW)/norm(RR.PUSH_RKR - RR.PUSH_UW), (RR.RKR_AXIS_1 - RR.RKR_AXIS_2)/norm(RR.RKR_AXIS_1 - RR.RKR_AXIS_2));
