function [FL, FR, RL, RR, F_ROLL_CENTER, R_ROLL_CENTER, FL_KINEMATICS, FR_KINEMATICS, RL_KINEMATICS, RR_KINEMATICS] = ETR11_GET_POINTS_v2(steering_wheel_angle, FL_COMPRESSION, FR_COMPRESSION, RL_COMPRESSION, RR_COMPRESSION)
...
FL =  KINEMATICS_SOLVER_v2(HP_FL, steering_wheel_angle, FL_COMPRESSION, 'FL');
FR =  KINEMATICS_SOLVER_v2(HP_FR, steering_wheel_angle, FR_COMPRESSION, 'FR');
RL =  KINEMATICS_SOLVER_v2(HP_RL, 0, RL_COMPRESSION, 'RL');
RR =  KINEMATICS_SOLVER_v2(HP_RR, 0, RR_COMPRESSION, 'RR');
