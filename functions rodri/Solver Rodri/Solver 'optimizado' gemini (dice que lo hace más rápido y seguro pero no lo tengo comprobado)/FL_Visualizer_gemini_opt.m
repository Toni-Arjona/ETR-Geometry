function FL_Viewer()
    ...
    % INICIALIZACIÓN DE VARIABLES (ESTIMACIÓN INICIAL PARA EL SOLVER)
    rkr0 = 0;
    x0 = [0, 0, 0];

    function updatePlot(steer_val, comp_val)
        % LLAMADA AL SOLVER MODIFICADO
        [FL, rkr0, x0] = FL_SOLVER_ETR11_rodri_gemini_opt(steer_val, comp_val, rkr0, x0);
